                ...
                messages=[
                    {
                        ...
                        "content": (
                            ...
                            f"   - **⚠️ EVITE FALSO NEGATIVO E CONFUSÃO COM CAIXAS DE REMÉDIO DE FUNDO ('GESTÃO' vs 'CESTÃO'):** Às vezes, o fundo do cesto promocional tem caixas de remédios coloridas impressas no CAD com nomes muito parecidos com o próprio cesto (como um produto/caixa chamado 'GESTÃO' em verde e laranja). O gpt ou Vision AI pode ler 'GESTÃO' na imagem e achar que é apenas a propaganda ou marca do remédio no fundo e, por isso, ignorar a imagem inteira retornando um JSON vazio '{{}}'! Isso é um ERRO GRAVE! Se você ler qualquer palavra parecida com 'CESTÃO', 'CESTAO', 'GESTÃO', 'GESTAO', 'RESTÃO', 'RESTAG', 'REST' junto com o número '400' ou '400mm' sobreposto a fundo colorido, você DEVE retornar 'CESTAO 400' com acabamento 'normal'! NUNCA ignore ou descarte isso achando que é apenas um medicamento ou propaganda de fundo! O texto principal sobreposto em letras grandes/coloridas é 'CESTÃO 400mm' ou similar!\n"
