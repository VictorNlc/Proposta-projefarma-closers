                ...
                messages=[
                    {
                        ...
                        "content": (
                            ...
                            f"   - Se o recorte contiver DOIS cestões pequenos separados (ex: dois quadrados de 400x400 no mesmo recorte, um ao lado do outro com espaço ou separados fisicamente), você DEVE classificar como 'CESTAO 400' com qtd: 2!\n"
                            f"   - Se apenas um cesto quadrado de 400mm estiver presente, classifique como 'CESTAO 400' com qtd: 1. **⚠️ ATENÇÃO EXTREMA:** A QUANTIDADE É SEMPRE POR MÓVEL FÍSICO, NÃO POR COMPARTIMENTOS INTERNOS! O 'CESTAO 400' é desenhado como um quadrado com divisórias/linhas no meio, mas representa apenas **UM** único móvel físico 'CESTAO 400'. NUNCA classifique um único cesto com divisões internas como qtd: 2! Se houver apenas um cesto quadrado, mesmo que tenha linhas dividindo-o por dentro, a quantidade é **1**!\n"
